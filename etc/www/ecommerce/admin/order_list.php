...
$query =("SELECT orders.oid,orders.orderdate, products.name, products.price, orders.quantity, orders.status FROM orders 
			...
			if(mysql_num_rows($result)>=1)
				{
					?>
						...
						<br/><table align="center" border="0px" cellpadding="2" cellspacing="1">
						 <tr bgcolor="white"><th>Order Date</th><th>Product Name</th><th>Unit price</th><th>Quantity</th>
						 <th>Status</th>
					<?php
