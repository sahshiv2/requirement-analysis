	...
	<body>
		<div class="wrapper">
			...
			<table align="center" cellpadding="2" cellspacing="1" border="0px">
				<tr bgcolor="silver"> <td  colspan="4" align="center">Ordered Item</td></tr>
				<tr bgcolor="silver"> <td>Item</td><td>Quantity</td><td>Unit Price(Rs.)</td><td>Total(Rs.)</td></tr>
				<?php
				...
				<table width="550" border="0" align="center" cellpadding="2">
					...
					<tr> 
						...
						<td>
							<input name="hidShippingPhone" type="text" id="hidShippingPhone" value="<?php echo $customer['phone'];?>" size="30"></td>
					</tr>
					<tr> 
				...
				<p align="center"> 
					&nbsp;&nbsp; 
					<input name="btnConfirm" type="submit"  style="font-face: 'Comic Sans MS'; font-size: larger; color: teal; background-color: #FFFFC0;id="btnConfirm" value="Confirm Order ">
				</form>
				</fieldset>
			<p>&nbsp;</p>
			</div>
			<div class="footer">
				<p>copy right content :created by  shiv4u85@yahoo.com</p>
			</div>
			</div>
	</body>
</html>