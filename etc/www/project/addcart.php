...
if(isset($_GET['pid']))
{
	...
	{
		$sql=$db->query("INSERT INTO cart (pid, productname, price, ctid) VALUES ('$id', '$productname', '$price', '$ctid')");
		header("Location:bag.php?item added to cart");
		exit();
	}
}
?>