...
$sid=session_id();
$query=$db->query("SELECT cart.cartid, products.image, cart.productname, brand.name, cart.quantity, cart.price
				FROM (cart INNER JOIN products ON cart.pid = products.pid) INNER JOIN brand ON products.brand = brand.id where ctid='$sid'") 
				or die(mysql_error);
$tot=0
?>
<html>
	...
	<body>
		<div class="wrapper">
			...
			<div class="rightcontent">
				...
				{
					echo ("<br/><br/><br/><center>You Have'nt addded items in the cart</center>");
				?>
