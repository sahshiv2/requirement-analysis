...
?>
        <tr bgcolor="#99FFCC"> 
            ...
            <td><?php echo $row['quantity']*$row['unitprice']; ?></td>
        </tr>
        <?php
}
?>
    ...
    <table width="550" border="0" align="center" cellpadding="2">
        ...
        <tr> 
            ...
            <td><?php echo $_POST['ShippingAddress']; ?>
                <input name="hidShippingAddress1" type="hidden" id="hidShippingAddress" value="<?php echo $_POST['ShippingAddress1']; ?>"></td>
        </tr>
        <tr> 
    ...
    <p>&nbsp;</p>
        ...
        <tr> 
            ...
            <td><?php echo $_POST['PaymentAddress']; ?>
                <input name="hidPaymentAddress1" type="hidden" id="hidPaymentAddress" value="<?php echo $_POST['PaymentAddress1']; ?>"></td>
        <tr> 
            <td width="150">Phone Number</td>
