...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>?step=2" method="post" name="frmCheckout" id="frmCheckout">
	<table width="550" border="0" align="center" cellpadding="2">
		...
		<tr> 
			...
			<td ><input name="ShippingAddress" type="text" class="box" id="ShippingAddress1" size="30" maxlength="100"></td>
		</tr>
		<tr> 
	...
	<table width="550" border="0" align="center" cellpadding="2">
		...
		<tr> 
			...
			<td ><input name="PaymentAddress" type="text" class="box" id="PaymentAddress1" size="30" maxlength="100"></td>
		</tr>
		<tr> 
